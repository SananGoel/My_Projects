...
export default function RegisterPage() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            setError(err.message.includes('email-already') ? 'Email already in use' : 'Password must be at least 6 characters');
            setLoading(false);
        }
    };
        ...
        <main style={{
            ...
            <div style={{ width: '100%', maxWidth: 400 }}>
                ...
                <div style={{ background: '#1a1d2e', borderRadius: 20, padding: 32, border: '1px solid #2d3148' }}>
                    <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 6, color: '#f1f5f9' }}>Create account</h2>
                    <p style={{ color: '#64748b', fontSize: 13, marginBottom: 24 }}>Join MediGuard to track your medications safely</p>
